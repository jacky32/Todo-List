...
class Project {
  ...
  createTodo(name, dueDate, description, starred) {
    const todo = new _todo_js__WEBPACK_IMPORTED_MODULE_0__["default"](name, dueDate, description, starred, this);

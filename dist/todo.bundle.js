...
class Todo {
  constructor(
    ...
    if (typeof dueDate == Date) {
      ...
      this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate);
    }
  ...
  buildSelf() {
    const buttons = _builder_js__WEBPACK_IMPORTED_MODULE_0__["default"].buildTodo(
      this.name,
      (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.dueDate, "dd. MM. yyyy"),
      this.description,
      this.starred
    );
    ...
    buttons.todoEdit.addEventListener("click", () => {
      const newValues = _builder_js__WEBPACK_IMPORTED_MODULE_0__["default"].buildNewTodoModal(
        this.name,
        (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.dueDate, "yyyy-MM-dd"),
        this.description,
        this.starred
      );
